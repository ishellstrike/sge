...
void Resources::Init()
{
    ...
    grad_shader->loadShaderFromSource(GL_VERTEX_SHADER,   s_dir + "gradient_builder.glsl");
    grad_shader->loadShaderFromSource(GL_FRAGMENT_SHADER, s_dir + "gradient_builder.glsl");
    grad_shader->Link();
    ...
    default_water_render->loadShaderFromSource(GL_VERTEX_SHADER,   s_dir + "minimal_watertest.glsl");
    default_water_render->loadShaderFromSource(GL_FRAGMENT_SHADER, s_dir + "minimal_watertest.glsl");
    ...
    soil->Load(t_dir  + "soil.png",  true, true);
    grass->Load(t_dir + "grass.png", true, true);
    snow->Load(t_dir  + "snow.png",  true, true);
    rock->Load(t_dir  + "rock.png",  true, true);
    PUSH_NVP(soil);
    PUSH_NVP(grass);
    PUSH_NVP(snow);
    PUSH_NVP(rock);
    ...
    rgb_to_luminance->loadShaderFromSource(GL_VERTEX_SHADER,   s_dir + "rgb_to_luminance.glsl");
    rgb_to_luminance->loadShaderFromSource(GL_FRAGMENT_SHADER, s_dir + "rgb_to_luminance.glsl");
    rgb_to_luminance->Link();
    rgb_to_luminance->Afterlink();
    PUSH_NVP(rgb_to_luminance);

    const auto & lerp_rgb_map = new BasicJargShader;
    lerp_rgb_map->loadShaderFromSource(GL_VERTEX_SHADER,   s_dir + "lerp_rgb_map.glsl");
    lerp_rgb_map->loadShaderFromSource(GL_FRAGMENT_SHADER, s_dir + "lerp_rgb_map.glsl");
    lerp_rgb_map->Link();
    lerp_rgb_map->Afterlink();
    PUSH_NVP(lerp_rgb_map);

    const auto & starnest = new BasicJargShader;
    starnest->loadShaderFromSource(GL_VERTEX_SHADER,   s_dir + "starnest.glsl");
    starnest->loadShaderFromSource(GL_FRAGMENT_SHADER, s_dir + "starnest.glsl");
    starnest->Link();
    starnest->Afterlink();
    PUSH_NVP(starnest);

    const auto & corona = new BasicJargShader;
    corona->loadShaderFromSource(GL_VERTEX_SHADER,   s_dir + "corona.glsl");
    corona->loadShaderFromSource(GL_FRAGMENT_SHADER, s_dir + "corona.glsl");
    corona->Link();
    corona->Afterlink();
    ...
    extract_glow->loadShaderFromSource(GL_VERTEX_SHADER,   s_dir + "extract_glow.glsl");
    extract_glow->loadShaderFromSource(GL_FRAGMENT_SHADER, s_dir + "extract_glow.glsl");
    extract_glow->Link();
    extract_glow->Use();
    ...
    tone_maping->loadShaderFromSource(GL_VERTEX_SHADER,   s_dir + "tone_maping.glsl");
    tone_maping->loadShaderFromSource(GL_FRAGMENT_SHADER, s_dir + "tone_maping.glsl");
    tone_maping->Link();
    tone_maping->Use();
    ...
    gausian_blur->loadShaderFromSource(GL_VERTEX_SHADER,   s_dir + "gausian_blur.glsl");
    gausian_blur->loadShaderFromSource(GL_FRAGMENT_SHADER, s_dir + "gausian_blur.glsl");
    gausian_blur->Link();
    gausian_blur->Use();
    ...
    gausian_blur2->loadShaderFromSource(GL_VERTEX_SHADER,   s_dir + "gausian_blur2.glsl");
    gausian_blur2->loadShaderFromSource(GL_FRAGMENT_SHADER, s_dir + "gausian_blur2.glsl");
    gausian_blur2->Link();
    gausian_blur2->Use();
    ...
    defered_color->loadShaderFromSource(GL_VERTEX_SHADER,   s_dir + "defered_color.glsl");
    defered_color->loadShaderFromSource(GL_FRAGMENT_SHADER, s_dir + "defered_color.glsl");
    defered_color->Link();
    defered_color->Afterlink();
    PUSH_NVP(defered_color);

    const auto & fake_planet = new BasicJargShader;
    fake_planet->loadShaderFromSource(GL_VERTEX_SHADER,   s_dir + "fake_planet.glsl");
    fake_planet->loadShaderFromSource(GL_FRAGMENT_SHADER, s_dir + "fake_planet.glsl");
    fake_planet->Link();
    fake_planet->Afterlink();
    PUSH_NVP(fake_planet);

    const auto & planet_ring = new BasicJargShader;
    planet_ring->loadShaderFromSource(GL_VERTEX_SHADER,   s_dir + "planet_ring.glsl");
    planet_ring->loadShaderFromSource(GL_FRAGMENT_SHADER, s_dir + "planet_ring.glsl");
    planet_ring->Link();
